    ...
    return (
      <footer className="footer">
        <div className="footer-content">
            ...
            <BioComponent name="Stewart Morales" github="https://github.com/stewartm12" linkedin="https://www.linkedin.com/in/stewart-m-44508a136/"/>
            <BioComponent name="Alec Caro" github="https://github.com/theneonwombat" linkedin="https://www.linkedin.com/in/alec-caro-5a713a5b/"/>
          ...
          <div className="footer-column">
            ...
            >
              ...
              <a href="https://github.com/hollyjphilly/HYPE/wiki" rel="noreferrer" target="_blank" className="footer-hype-link">
                Check out Hype at Github
            ...
            <BioComponent name="Holly Phillips" github="https://github.com/hollyjphilly" linkedin="https://www.linkedin.com/in/hollyjphillips/"/>
            <BioComponent name="Hammad Khalid" github="https://github.com/HammadKhalid101" linkedin="https://www.linkedin.com/in/hammad-khalid-071823143/"/>
        </div>
      </footer>
    )
  }
